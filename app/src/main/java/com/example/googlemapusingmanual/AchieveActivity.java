...
//    };
    ...
    private ArrayList<CheckBox> seatViewList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seatViewList = new ArrayList<CheckBox>(20);

        for(int count=0; count<20; count++) {
            CheckBox view = new CheckBox(getApplicationContext());

            view.setId(count);
            view.setText(count + "!@ggggggggg");
            view.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 20); // textSize
