...
public class weightTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        yAxisLeft.setAxisMinimum(ideal_weight-15);
        yAxisLeft.setAxisMaximum(ideal_weight+15);
        ...
        yAxis.setAxisMinimum(ideal_weight-15);
        yAxis.setAxisMaximum(ideal_weight+15);
